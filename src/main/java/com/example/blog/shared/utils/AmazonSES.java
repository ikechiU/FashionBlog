...
public class AmazonSES {
    ...
    final String HTMLBODY = "<h1>Please verify your email address</h1>"
            + "<p>Kudos for registering with  Ikechi Fashion Blog. To complete registration process and be able to log in,"
    ...
    final String TEXTBODY = "Please verify your email address. "
            + "Kudos for registering with Ikechi Fashion Blog. To complete registration process and be able to log in,"
    ...
    final String PASSWORD_RESET_HTMLBODY = "<h1>A request to reset your password</h1>"
            + "<p>Hi, $firstName!</p> "
            + "<p>Someone has requested to reset your password with Ikechi Fashion Blog. If it were not you, please ignore it."
    ...
    final String PASSWORD_RESET_TEXTBODY = "A request to reset your password "
            + "Hi, $firstName! "
            + "Someone has requested to reset your password with Ikechi Fashion Blog. If it were not you, please ignore it."
    ...
    public void verifyEmail(UserDto studentDto) {
        awsMasked();
        ...
        String htmlBodyWithToken = HTMLBODY.replace("$tokenValue", studentDto.getEmail());
        String textBodyWithToken = TEXTBODY.replace("$tokenValue", studentDto.getEmail());
